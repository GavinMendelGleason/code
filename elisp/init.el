...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cuda-mode vterm nix-mode chatgpt-shell rust-playground handlebars-mode python-black prettier-rc typescript-mode json-mode company lsp-ui use-package graphql-mode restclient js2-mode session wc-mode exec-path-from-shell ttl-mode yaml-mode tide helm-lean company-lean ## lean-mode rustic flycheck magit-delta so-long tramp exwm xelb csv-mode rust-mode with-editor markdown-preview-eww spinner lsp-mode auto-sudoedit tramp-theme tramp-term flycheck-mercury yasnippet web-mode utop unicode-fonts tuareg suscolors-theme sparql-mode sml-mode redprl ocp-indent n3-mode merlin markdown-mode magit idris-mode ghc fstar-mode))
