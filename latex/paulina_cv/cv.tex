...
{
  \begin{itemize}
  \item \textbf{Tuition, Language Testing and QA}
  \end{itemize}
}

\cventry{2010 -- }{Freelance Translation}{English-German/German-English}{Dublin}{}
{
  \begin{itemize}
  \item \textbf{Translation:} Translation of literary and academic texts.
  \end{itemize}
}
