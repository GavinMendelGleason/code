...
\cventry{2017 -- 2021}{Translation Project Manager/Partner Coordinator}{Translators Without Borders}{Dublin}{}
{
...
{
  \begin{itemize}
  \item \textbf{Tuition and Translation and QA}
  \end{itemize}
}
...
{
  \begin{itemize}
  \item \textbf{Translation:} Translation of literary and academic texts (bibliography included below).
  \end{itemize}
}

\section{References}

\cvreference{Anete Raugule}{Partnership Team Manager}{}{Translators Without Borders}{}{anete.raugule@natakallam.com}{}

\cvreference{Alan Barrett}{Senior Developer}{}{The Rosetta Foundation}{Dublin}{alanabarrett0@gmail.com}{}

\section{Activism}

\cvlistitem{Founding member of SPARK single parent advocacy group.}
\cvlistitem{Activist in Attac Ireland.}
\cvlistitem{Involved in housing and workers rights campaigns.}
